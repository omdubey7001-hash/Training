...
export default function Sidebar() {
  return (
    <aside className="h-[calc(100vh-32px)] w-64 m-4 bg-white rounded-xl flex flex-col transition-transform duration-300 shadow-xl border border-gray-100/50 relative z-50">
      ...
      {/* Help Card */}
      <div className="p-4">
        <div className="relative overflow-hidden rounded-2xl bg-teal-400 p-4 text-white shadow-lg transform -translate-y-12">
          <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-white/20" />

          <div className="relative z-10 mb-3 flex h-8 w-8 items-center justify-center rounded-lg bg-white text-teal-500 shadow-sm">
            <HelpCircle size={18} />
          </div>
